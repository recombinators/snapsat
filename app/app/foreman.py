...
def list_worker_instances(conn, worker_type):
    """
    Return list of worker instances in order of launch time, most recent first.
    """
...
def tag_instances(instances, tag_value_dict):
    """
    Add tags to instances. Expects a list of instances and a dict of tag: value.
    """
